...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { email: @login.email, name: @login.name, password_digest: @login.password_digest }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { email: @login.email, name: @login.name, password_digest: @login.password_digest }
    assert_redirected_to login_path(assigns(:login))
  end
