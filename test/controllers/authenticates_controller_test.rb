...
class AuthenticatesControllerTest < ActionController::TestCase
  ...
  test "should create authenticate" do
    assert_difference('Authenticate.count') do
      post :create, authenticate: { email: @authenticate.email, name: @authenticate.name, password_digest: @authenticate.password_digest }
    end
  ...
  test "should update authenticate" do
    patch :update, id: @authenticate, authenticate: { email: @authenticate.email, name: @authenticate.name, password_digest: @authenticate.password_digest }
    assert_redirected_to authenticate_path(assigns(:authenticate))
  end
